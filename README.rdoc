...
Version 1.1.8 includes some spec fixes and avoidance of deprecation warnings, courtesy of {bdon}[https://github.com/bdon]!
...
* Brandon Liu (github:{bdon}[https://github.com/bdon]) -- spec improvements
